...
const char* ssid     = "Ваш вайфай";
const char* password = "пароль від вайфаю";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "апі ключ з сайту openweathermap.org/";                      // See: https://openweathermap.org/
...
String City             = "Your home city з сайту bulk.openweathermap.org/sample/";                          // Your home city See: http://bulk.openweathermap.org/sample/
String CityUA           = "Назва вашого міста на укр мові";
...
String Language         = "UA";                            // NOTE: Only the weather description is translated by OWM
